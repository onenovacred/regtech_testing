...
class LiveEquifaxController1 extends Controller
{
        ...
        public function scoreEquifaxSubmit(Request $request){
            ...
            //   ];
              ...
              if(isset($responseData["statusCode"]) && $responseData["statusCode"]==102){
                   ...
                   return response()->json(['score_api_message',$score_api_message]);
             }
             if(isset($responseData["statusCode"]) && $responseData["statusCode"]==200)
             {
              ...
              return response()->json(['score_api_success_message',$score_api_success_message]);
             }    
             return response()->json(['score_api_success_message',$score_api_success_message]);
        //   return response()->json(['other.equifax_score']);
