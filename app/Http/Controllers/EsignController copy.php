            ...
            case 'one':
                ...
                if ($page_method_option == 'single') {
                    ...
                    if (count($existing_pdf) == 1) {
                        ...
                        $getEsignoutput = shell_exec('java -jar "C:\eSign2.1.jar" 1 "" "' . $sample_pdf_path . '" "ASPZTPLUAT007191" 1 "' . $url . '" "' . $certificate . '" "123456" "' . $tick_image . '" 15 "imported certificate" ' . $request->signature_stamp_page . ' "' . $request->name_show_signature . '" "' . $request->location_show_signature . '" "' . $request->reasone_for_signature . '" 55 0 120 60 "" "" 2>&1');
