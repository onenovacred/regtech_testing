...
@section('title', 'CORPORATE GSTIN Confidence')
    ...
    <div class="col-md-6 offset-md-3">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">CORPORATE GSTIN WITH CONFIDENCE</h3>
                <a role = "button" class = "btn btn-light float-right" 
                href = "{{ route('kyc.corporate_gstin_confidence_api') }}">GSTIN APIs</a>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <form role="form" method="post" action="{{route('kyc.corporate_gstin_confidence')}}">
                            {{csrf_field()}}
                                <div class="form-group">
                                    <label for="name">Corporate GSTIN Number</label>
                                    <input type="text" class="form-control" id="corporate_gstin" name="corporate_gstin" value="{{old('corporate_gstin')}}" placeholder="Ex: ABCDE1234N" required>
                                </div>
                                <div class="form-group">
                                    <label for="name">Name as per GST</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                      <div>
                        ...
                        <p><strong>Confidence:</strong> @if(isset($corporate_gstin[0]['confidence'])){{ $corporate_gstin[0]['confidence'] }}@else '' @endif</p>
