...
<body>
    <div class="container p-0">
        <div class="card px-4">
            ...
            <form role="form" method="post" action="{{ route('e-nach-initiate-payment-post') }}">
                {{ csrf_field() }}
                <div class="row gx-3">
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text_p mb-1">Amount <span class="fa-sharp fa-solid fa-circle-info amount"></span></p>
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text_p mb-1">Loan Id</p>
                            <input type="text" class="form-control mb-3" placeholder="Enter Loan Id"
                                name="productinfo" id="productinfo"  value=""/>
                         
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text_p mb-1">Name</p>
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text_p mb-1">Phone Number</p>
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text_p mb-1">Bank Code</p>
                            <input type="text" class="form-control mb-3 pt-2" placeholder="Enter Bank Code" name="udf1"
                                id="udf1" />
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text_p mb-1">Account Number</p>
                            <input type="text" class="form-control mb-3 pt-2" placeholder="Enter Account Number" name="udf2"
                                id="udf2" />
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text_p mb-1">Bank Name</p>
                            <input type="text" class="form-control mb-3 pt-2" placeholder="Enter Bank Name" name="udf3"
                                id="udf3" />
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text_p mb-1">IFSC Code</p>
                            <input type="text" class="form-control mb-3 pt-2" placeholder="Enter IFSC Code"
                                name="udf4" id="udf4" />
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text_p mb-1">Maximum Amount<span class="fa-sharp fa-solid fa-circle-info udf5"></span></p>
                            <input type="text" class="form-control mb-3 pt-2" placeholder="Enter Maximum Amount"
                                name="udf5" id="udf5" />
                    ...
                    <div class="col-12">
                        <div class="d-flex flex-column">
                            <p class="text_p mb-1">Frequency</p>
                            <input type="text" class="form-control mb-3 pt-2" placeholder="Enter Frequency"
                                name="udf6" id="udf6" />
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text_p mb-1">Start Date<span class="fa-sharp fa-solid fa-circle-info final-collection-date"></span></p>
        ...
        $(document).ready(function() {
            $(document).ready(function() {
                $('.udf5').popover({
                    content: function() {
                        var infoDetails =
                            '<span class="amount-udf5"><small>Maximum amount should be above from amount. </small></span>';
                        return infoDetails;
                    },
                ...
                $('.final-collection-date').popover({
                    content: function() {
                        var infoDetails =
                            '<span class="amount-udf5"><small>start date will be by default 1 year from mandate registration date </small></span>';
                        return infoDetails;
                    },
                    trigger: 'hover', // Show popover on click (you can use 'hover' if you want to show on hover)
                    placement: 'right',
