            ...
            <div class = "card-body">
                <div class="row">
                    <div class="col-md-12">
                      <div>
                        <p>Aadhaar Number: {{ $aadhaar[0]['aadhaar_validation']['data']['aadhaar_number'] }}</p>
                        <p>Age Range: {{ $aadhaar[0]['aadhaar_validation']['data']['age_range'] }}</p>
                        <p>Gender: @if($aadhaar[0]['aadhaar_validation']['data']['gender'] == 'M') Male @elseif($aadhaar[0]['aadhaar_validation']['data']['gender'] == 'F') Female @else {{$aadhaar['data']['gender']}} @endif</p>
                        <p>Mobile: {{ '*******'.$aadhaar[0]['aadhaar_validation']['data']['last_digits'] }}</p>
                        <p>State: {{ $aadhaar[0]['aadhaar_validation']['data']['state'] }}</p>
                        <p>Aadhaar Verification: {{ $aadhaar[0]['aadhaar_validation']['message_code'] }}</p>
                      </div>
                    </div>
                </div>
            </div>
