...
<div class="row">
    <div class="col-md-6 offset-md-3">
        <div class="card card-primary">
            ...
            <div class="card-body">
                @if(isset($telecom_submit_otp['statusCode']) &&  $telecom_submit_otp['statusCode']== '102')
                    <div class="alert alert-danger" role="alert">
                        OTP is Invalid. 
                    </div>
                @endif

                @if(isset($telecom_submit_otp['statusCode']) &&  $telecom_submit_otp['statusCode'] == '404' || isset($telecom_submit_otp['statusCode']) &&  $telecom_submit_otp['statusCode'] == '400')
                    <div class = "alert-danger alert-danger" role = "alert">
                        Server Error, Please try later
                    </div>
                @endif
                @if(isset($telecom_submit_otp['statusCode']) &&  $telecom_submit_otp['statusCode'] == '401')
                <div class="alert-danger alert-danger" role = "alert">
                    Error. Please contact techsupport@docboyz.in. for more details
                </div>
                @endif
                @if(isset($telecom_submit_otp['statusCode']) &&  $telecom_submit_otp['statusCode'] == '500')
                <div class="alert alert-danger" role="alert">
                    Internal Server Error. Please contact techsupport@docboyz.in. for more details.
                </div>
                @endif
                @if(isset($telecom_submit_otp['statusCode']) &&  $telecom_submit_otp['statusCode'] == '103')
                <div class="alert alert-danger" role="alert">
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <form role="form" method="post" action="{{ route('kyc.single.search.telecom_submit_otp_search') }}">
                            {{csrf_field()}}
