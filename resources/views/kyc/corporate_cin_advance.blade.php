        ...
        <div class="col-md-6 offset-md-3">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">CORPORATE CIN Advance</h3>
                    <a role = "button" class = "btn btn-light float-right"
                        href = "{{ route('kyc.corporate.advanced.api') }}">CIN Advance APIs</a>
                </div>
                <div class="card-body">
              ...
              @endif
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <form role="form" method="post" action="{{ route('kyc.corporate.advanced') }}">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="name">CORPORATE CIN Number</label>
                                    <input type="text" class="form-control" id="cinNumber" name="cinNumber"
                                        value="{{ old('cinNumber') }}" placeholder="Enter a cin number" />
                                </div>
