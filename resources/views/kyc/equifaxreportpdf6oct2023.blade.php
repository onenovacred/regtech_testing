			...
			<table>
				<tbody>
					<tr>
						...
						{{isset($equifax['InquiryResponseHeader']['ClientID']) ? $equifax['InquiryResponseHeader']['ClientID'] : ""}}
						</td>
						<td><span class="td-style">DATE:</span> {{ isset($myarray['date']) ? $myarray['date'] : "" }}</td>
					</tr>
					<tr>
						<td><span class="td-style">REPORT ORDER NO:</span> {{ isset($myarray['orderNo']) ? $myarray['orderNo'] : "" }}</td>
						<td><span class="td-style">TIME:</span> {{ isset($myarray['time']) ? $myarray['time'] : "" }}</td>
					</tr>
					<tr>
						<td><span class="td-style">REFERENCE NUMBER:</span> {{ $myarray['CustRefField'] }}</td>
					</tr>
				</tbody>
			</table>
		</div>
				...
				<table class = "table" cellspacing="0">
					...
					<tbody>
						...
						<tr class="td-elements">
							...
							<td><span>PAN:</span> {{ isset($myarray['PAN']) ? $myarray['PAN'] : "" }}</td>
							<td><span>Home:</span> {{ isset($myarray['Number']) ? $myarray['Number'] : "" }}</td>
						</tr>
						<tr class="td-elements">
							<td><span>Alias Name:</span></td>
							<td><span>Voter ID:</span>{{ isset($myarray['VoterID']) ? $myarray['VoterID'] : "" }}</td>
							<td><span>Office:</span> </td>
						</tr>
						<tr class="td-elements">
							<td><span>DOB:</span> {{ isset($myarray['DOB']) ? $myarray['DOB'] : "" }}</td>
							<td><span>Passport ID: {{ isset($myarray['NationalIDCard']) ? $myarray['NationalIDCard'] : "" }}</span></td>
							<td><span>Mobile:</span> </td>
						</tr>
						<tr class="td-elements">
							<td><span>Age:</span> {{ isset($myarray['age']) ? $myarray['age'] : "" }}</td>
							<td><span>UID:</span></td>
							<td><span>Alt. Home/Other No. :</span> </td>
						</tr>
						<tr class="td-elements">
							<td><span>Gender:</span> {{ isset($myarray['gender']) ? $myarray['gender'] : "" }}</td>
							<td><span>Driver's License: {{ isset($myarray['driving_licence']) ? $myarray['driving_licence'] : "" }}</span></td>
				...
				<div class = "row">
					...
					<div class = "row">
						...
						<table>
							<thead class = "data-title">
								<tr>
									<th scope = "col" colspan = 4>Accounts</td>
								</tr>
							</thead>
						...
						<table style = "border: 1px solid black;">
							<tbody>
								<tr>
									<td style = "text-decoration: underline;">History</td>
								</tr>
