        ...
        <div class="col-md-6 offset-md-3">
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <a role = "button" class = "btn btn-light float-right" href = "{{ route('kyc.udyam.details.api.search.v2') }}">UdyamCard 
                         APIs</a>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <form role="form" method="post" action="{{ route('kyc.udyam.details.search.v2') }}">
                                {{ csrf_field() }}
