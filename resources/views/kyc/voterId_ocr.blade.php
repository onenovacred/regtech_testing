                            ...
                            <div class="col-md-12">
                                <div>
                                    <p><strong>Voter Description:&nbsp;&nbsp;</strong>
                                        @if (!empty($voterid['voterid']['detected_text']))
                                            {{ $voterid['voterid']['detected_text'] }}
                                        @else
                                            null
                                        @endif
                                    </p>
                                    <p><strong>Name:&nbsp;&nbsp;</strong>
                                        @if (!empty($voterid['voterid']['extracted_info']['name']))
                                            {{ $voterid['voterid']['extracted_info']['name'] }}
                                        @else
                                        null
                                        @endif
                                    </p>
                                    <p><strong>Voter Id:&nbsp;&nbsp;</strong>
                                        @if (!empty($voterid['voterid']['extracted_info']['voter_id']))
                                            {{ $voterid['voterid']['extracted_info']['voter_id'] }}
                                        @else
                                        null
                                        @endif
                                    </p>
