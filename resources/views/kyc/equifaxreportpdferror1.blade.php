			...
			<table>
				<tbody>
					<tr>
						...
						{{isset($equifaxdetails['InquiryResponseHeader']['ClientID']) ? $equifaxdetails['InquiryResponseHeader']['ClientID'] : ""}}
						</td>
						<td><span class="td-style">DATE:</span> {{ isset($equifaxdetails['InquiryResponseHeader']['Date']) ? $equifaxdetails['InquiryResponseHeader']['Date'] : "" }}</td>
					</tr>
					<tr>
						<td><span class="td-style">REPORT ORDER NO:</span> " "</td>
						<td><span class="td-style">TIME:</span> {{ isset($equifaxdetails['InquiryResponseHeader']['Time']) ? $equifaxdetails['InquiryResponseHeader']['Time'] : "" }}</td>
					</tr>
					<tr>
						<td><span class="td-style">REFERENCE NUMBER:</span> {{ $equifaxdetails['InquiryResponseHeader']['CustRefField'] }}</td>
					</tr>
				</tbody>
			</table>
		</div>
				...
				<table>
					<thead>
						<tr>
							<td>
								<h3 class = "data-field">
									Consumer Name: {{ isset($equifaxdetails['InquiryRequestInfo']['FirstName']) ? $equifaxdetails['InquiryRequestInfo']['FirstName'].$equifaxdetails['InquiryRequestInfo']['LastName'] : "" }}
									
								</h3>
								<h3 class = "data-field">
									
									Mobile: {{ isset($equifaxdetails['InquiryRequestInfo']['InquiryPhones'][0]['Number']) ? $equifaxdetails['InquiryRequestInfo']['InquiryPhones'][0]['Number'] : "" }}
								</h3>
							</td>
						</tr>
					</thead>
				...
				<table class = "table" cellspacing="0">
					...
					<tbody>
						...
						<tr class="td-elements">
							...
							<td><span>Home:</span> {{ isset($equifaxdetails['InquiryRequestInfo']['InquiryPhones'][0]['Number']) ? $equifaxdetails['InquiryRequestInfo']['InquiryPhones'][0]['Number'] : "" }}</td>
						</tr>
						<tr class="td-elements">
