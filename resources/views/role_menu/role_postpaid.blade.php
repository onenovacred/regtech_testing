...
<li class="nav-item">
    <?php
    $user_menus=DB::table('menu_permission')->where('user_id',Auth::user()->id)->get();
    ?>
...
<?php
    $user_api_group=DB::table('user_scheme_master')->select('api_group_id')->where('user_id',Auth::user()->id)->groupBy('api_group_id')->get()->toArray();
    $arrayName = array();
    $myarr = "";
