...
<div class="row">
    <div class="col-md-6 offset-md-3">
        ...
        @if(!empty($aadhaar_otp_genrate) && isset($aadhaar_otp_genrate[0]['aadhaar_validation']['statusCode']) && $aadhaar_otp_genrate[0]['aadhaar_validation']['statusCode'] == 200)
        <div class="card card-success">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                      <div>
                        <p>client_id: {{ $aadhaar_otp_genrate[0]['aadhaar_validation']['data']['requestId'] }}</p>
                        <p>otp_sent: {{ $aadhaar_otp_genrate[0]['aadhaar_validation']['data']['otpSentStatus'] }}</p>
                        <p>if_number: {{ $aadhaar_otp_genrate[0]['aadhaar_validation']['data']['if_number'] }}</p>
                        <p>valid_aadhaar: {{ $aadhaar_otp_genrate[0]['aadhaar_validation']['data']['isValidAadhaar'] }}</p>
                      </div>
                    </div>
                </div>
            </div>
