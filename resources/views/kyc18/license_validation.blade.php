        ...
        <div class="card card-success">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                      <div>
                      <p>License Number: {{ $license_validation[0]['license_validation']['response']['dlNumber'] }}</p>
                        <p>Name: {{ $license_validation[0]['license_validation']['response']['name'] }}</p>
                        <p>Father / Husband Name: {{ $license_validation[0]['license_validation']['response']['father/husband'] }}</p>
                        <p>DOB: {{$license_validation[0]['license_validation']['response']['dob']}}</p>
                        <p>Permanent Address: {{ $license_validation[0]['license_validation']['response']['address'][0]['completeAddress'] }}</p>
                        <p>Permanent ZIP: {{ $license_validation[0]['license_validation']['response']['address'][0]['pin'] }}</p>
                        <p>State: {{ $license_validation[0]['license_validation']['response']['address'][0]['state'] }}</p>
                        <p>District: {{ $license_validation[0]['license_validation']['response']['address'][0]['district'] }}</p>
                        <p>Image: <br><img src="{{ $license_validation[0]['license_validation']['response']['img'] }}" alt="Profile"></p>
