                                                ...
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            //     if (is_array($data)) {
                                                            //         echo '<select id="stage_id' . $sub_menu->id . '" name="stage_response' . $sub_menu->id . '[]" class="form-control selectpicker multiselect" multiple="" data-live-search="true" data-actions-box="true">';
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            //     if (is_array($data)) {
                                                            //         echo '<select id="request_value' . $sub_menu->id . '" name="request_value' . $sub_menu->id . '[]" class="form-control selectpicker multiselect" multiple="" data-live-search="true" data-actions-box="true">';
                                    ...
                                    @if (count($sub_menus) > 0)
                                        @foreach ($sub_menus as $key1 => $sub_menu)
                                            <div class="row" id="editContent{{ $sub_menu->id }}"
                                                ...
                                                <div class="col-md-6" id="custom_plan{{ $sub_menu->id }}">
                                                    <?php
                                                    $schemeRangeExploded = [];
                                                    $schemePriceExploded = [];
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    //     $data = json_decode($sub_menusid[0]->request_table_name);
                                                    //     if (is_array($data)) {
                                                    //         echo '<select id="stage_id' . $sub_menu->id . '" name="request_value' . $sub_menu->id . '[]" class="form-control selectpicker multiselect" multiple="" data-live-                                                                search="true" data-actions-box="true">';
