                    ...
                    <form role="form" id="frmAddScheme" method="post" action="{{ route('user.create') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="one_time_comission"
                                        name="one_time_comission" placeholder="One Time Comission (OTC)">
                                </div>
                            </div>
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-md-3" style="padding-right: 15px;">
                                <input class="form-control" type="text" name="plan_amount" id="plan_amount"
                                    value="" placeholder="Plan Amount" disabled>
                            </div>
                        </div>
                        <hr>
                                    ...
                                    @foreach ($sub_menus as $sub_menu)
                                        <div class="row" style="padding-bottom: 5px;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text"
                                                            ...
                                                            id="txtUserPricedemo{{ $sub_menu->id }}" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                //     if (is_array($data)) {
                                                //         echo '<select id="stage_id'.$sub_menu->id.'" name="stage_response'.$sub_menu->id.'[]" class="form-control selectpicker multiselect w-75" multiple="" data-live-search="true" data-actions-box="true">';
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                //     if (is_array($data)) {
                                                //         echo '<select id="stage_id'.$sub_menu->id.'" name="request_value'.$sub_menu->id.'[]" class="form-control selectpicker multiselect w-75" multiple="" data-live-search="true" data-actions-box="true">';
                                ...
                                @if (count($sub_menus) > 0)
                                    @foreach ($sub_menus as $sub_menu)
                                        <div class="row" style="padding-bottom: 5px;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <select name="planType[]" id="planType_{{ $sub_menu->id }}"
                                                                class="planType form-control selectpicker multiselect"
                                            ...
                                            <div class="col-md-1 text-center" id="regtech_plan{{ $sub_menu->id }}">
                                                <input type="text" class="form-control"
                                                    id="txtPlanPrice{{ $sub_menu->id }}"
                                                    name="txtPlanPrice{{ $sub_menu->id }}" value="" disabled>
                                            </div>

                                            <div class="col-md-1 text-center" id="user_price{{ $sub_menu->id }}">
                                                <input type="text"
                                                    class="form-control grouptext_{{ $sub_menu->api_group_id }}"
                                                    id="txtUserPrice{{ $sub_menu->id }}" disabled>
                                            </div>

                                            <div class="col-md-5" id="custom_plan{{ $sub_menu->id }}"
                                                style="display:none">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                //     $data = json_decode($sub_menusid[0]->request_table_name);
                                                //     if (is_array($data)) {
                                                //         echo '<select id="'.$sub_menu->id.'" name="request_value'.$sub_menu->id.'[]" class="form-control selectpicker multiselect w-75" multiple="" data-live-search="true" data-actions-box="true">';
                        ...
                        <div class="text-center" id="submitButton">
                            <button type="button" id="btnAdd" class="btn btn-primary"
                                style="width:40%; margin: 20px 0 20px 0">Add</button>
                        </div>
                    </form>
                </div>
            </div>
