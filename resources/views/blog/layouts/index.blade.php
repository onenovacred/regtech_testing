...
<body>
    <div id="logo">
        <span class="big-logo">Blog</span>
    </div>
    <div id="left-menu">
        <ul>
            <li @if(request()->route()->named('blog_dashboard')) class="active" @else class="" @endif>
              <a href="{{route('blog_dashboard')}}">
                    <i class="fa-solid fa-user"></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <li @if(request()->route()->named('blog_list')) class="active" @else class=" " @endif><a href="{{route('blog_list')}}">
                    <i class="fa-solid fa-user"></i>
                    <span>RegTech</span>
                </a>
            </li>
            {{-- <li @if(request()->route()->named('docblog')) class="active" @else class=" " @endif class="active"><a href="{{route('docblog')}}">
                    <i class="fa-solid fa-user"></i>
                    <span>Docboyz</span>
                </a>
            </li> --}}
    ...
    <div id="main-content">
        <div id="header">
            <div class="header-left float-left">
                <i id="toggle-left-menu" class="ion-android-menu fa-solid fa-bars"></i>
            </div>
