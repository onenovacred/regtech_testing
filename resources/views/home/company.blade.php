...
<div class="carousel-inner">
    <div class="carousel-item active">
        ...
        <img src="{{asset('images/web_image5.jpg')}}" width="100%" height="350" style="filter: brightness(50%)">
    </div>
</div>
		...
		<div class="row text-center text-white bg-danger" style="border-radius: 20px;">
	        <div class="col-sm-4">
                <div class="counter bg-danger">
                    ...
                    <span style="position:absolute; left: 173px; top: 32px; z-index: 2;"><h1>+</h1></span>
            ...
            <div class="col-sm-4">
               <div class="counter bg-danger">
                    ...
                    <span style="position:absolute; right: 90px; top: 32px; z-index: 2;"><h1>+</h1></span>
            ...
            <div class="col-sm-4">
                <div class="counter bg-danger">
                    <h2 class="timer count-title count-number font-weight-bold" data-to="10000" data-speed="1500"></h2>
                    <span style="position: absolute; right: 62px; top: 32px;  z-index: 2;"><h1>+</h1></span>
