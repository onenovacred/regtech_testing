        ...
        <div class="row" style="width: 100%;padding-top: 20px;">
            <div class="col-md-6 col-sm-5 col-xs-5" style="width:45%;">
                <div class="panel panel-success" >
                    <div class="heading ">
                        <h3 class="panel-title" style="padding-top: 5px;padding-left: 10px;padding-bottom: -5px;margin-bottom: -10px;"><b>Pickup Details</b></h3><hr>
                    </div>
                    <div class="table-responsive" style="padding:5px;margin-top: -20px;margin-bottom:10px;">
                        <table>
                            <tbody>
                            <tr>
                                <td class="title"><strong>Application ID : </strong>asd</td>
                            </tr>
                            <tr>
                                <td class="title"><strong>Applicant : </strong>asd</td>
                            </tr>
                            <tr style="border-bottom: 0">
                                <td class="title" style="border-bottom: 0"> <strong>Product : </strong>asd</td>
                            </tr>
                            <tr>
                                <td class="title"><strong>Address : </strong>asd</td>
                            </tr>
                            <tr>
                                <td class="title"><strong>City : </strong>asd</td>
                            </tr>
                            <tr>
                                <td class="title"><strong>State : </strong>asd</td>
                            </tr>
                            <tr>
                                <td class="title"><strong>Status : </strong>asd</td>
                            </tr>
                            <tr>
                                <td class="title"><strong>Document Submited Date : </strong>Not Submitted</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
