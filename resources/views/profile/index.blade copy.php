    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <form role="form" method="post" action="{{ route('user.submitProfile') }}"
                                            ...
                                            <span style="font-size:18px;"><b>Upload Documents</b>&nbsp;&nbsp;<small
                                                    style="color:red;">(Max
                                                    5 MB accepted documents types: pdf, jpeg, jpg,
                                                    png)</small></span>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="bankstatement">Bank Statement <span
                                                        style="color:red; font-size:20px;">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="otherdocument">Other <span
                                                        style="color:red; font-size:20px;">*</span></label>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        @php
                                            $pancardDocument = Storage::disk('s3')->temporaryUrl('uploads/agent_documents/images/' . $user->documents->pancard_document, now()->addMinutes(50));
                                            $aadharDocument = Storage::disk('s3')->temporaryUrl('uploads/agent_documents/images/' . $user->documents->aadharcard_document, now()->addMinutes(50));
                                            $bankDocument = Storage::disk('s3')->temporaryUrl('uploads/agent_documents/images/' . $user->documents->bank_document, now()->addMinutes(50));
                                            $otherDocument = Storage::disk('s3')->temporaryUrl('uploads/agent_documents/images/' . $user->documents->other_document, now()->addMinutes(50));

                                            $pancard_file_exe = pathinfo($user->documents->pancard_document, PATHINFO_EXTENSION);
                                            $aadharcard_file_exe = pathinfo($user->documents->aadharcard_document, PATHINFO_EXTENSION);
                                            $bankcard_file_exe = pathinfo($user->documents->bank_document, PATHINFO_EXTENSION);
                                            $othercard_file_exe = pathinfo($user->documents->other_document, PATHINFO_EXTENSION);
                                        @endphp
                                        <div class="row">
                                            <div class=" col-md-6">
                                                <div class="mt-5">
                                                        ...
                                                        @else
                                                            <div class="text-center">
                                                                <img src="{{$bankDocument}}"
                                                                    style="width:200;height:200;object-fit:fill;" alt="no image"/>
                                                                <br />
                                                                <a href="{{$bankDocument}}" target="_blank">
                                                                    <button class="btn btn-success btn-sm"
                                                                        style="margin-top:10px;">Download Image</button>
                        ...
                        @if (count($users) > 0)
                            ...
                            @foreach ($users as $key => $value)
                                <div id="accordion{{ $value->id }}" class="accordion">
                                    <div class="card">
                                        <div class="card-header collapsed" data-toggle="collapse" id="heading{{$value->id}}"
                                            href="#collapseOne{{ $value->id }}"
                ...
                {{-- <div class="tab-pane fade" id="businessProfile" role="tabpanel" aria-labelledby="business-profile">
            ...
            function fetchDocuments(user_id) {
                $.ajax({
                    ...
                    success: function(response) {
                           if (response.submit_date != null && response.document_pancard != null && response
                            .aadhar_document != null && response.bank_document != null && response.other_document !=
                            null) {
                            ...
                            let pncard_doc = response.documents.pancard_document;
                            let pncard_doc_exe = pncard_doc.split('.').pop().toLowerCase();
                            let aadhar_doc = response.documents.aadharcard_document;
                            let aadhar_doc_exe = aadhar_doc.split('.').pop().toLowerCase();
                            let bank_doc = response.documents.bank_document;
                            let bank_doc_exe = bank_doc.split('.').pop().toLowerCase();
                            let other_doc = response.documents.other_document;
                            let other_doc_exe = other_doc.split('.').pop().toLowerCase();
                                 ...
                                 <div class="col-md-6 col-sm-6 col-lg-6">
                                  ...
                                  <form id="documentsUser" enctype="multipart/form-data">
                                    ...
                                    <span style="font-size:18px;"><b>Upload Documents</b>&nbsp;&nbsp;<small
                                            ...
                                            png)</small></span>
                                    <div class="form-group">
                                        <label for="pancard_docupload">Pan Card <span
                                                style="color:red; font-size:20px;">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="aadharcard_docupload">Aadhar Card <span
                                                style="color:red; font-size:20px;">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="bankstatement_docupload">Bank Statement <span
                                                style="color:red; font-size:20px;">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="otherdocument_upload">Other <span
                                                style="color:red; font-size:20px;">*</span></label>
                                 ...
                                 <div class="col-md-6 col-sm-6 col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-sm-6">
                                               ...
                                               <div class="mt-5">
                                                     <h5 class="text-center"><strong>Oters Document.</strong></h5>
                                                     <div class="text-center">
                                                 ${
                                                    other_doc_exe=='pdf'?`
