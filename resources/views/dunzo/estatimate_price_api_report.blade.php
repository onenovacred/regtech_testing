		...
		<div class = "header">
			<div class="row">
			 ...
			 <table>
				<tbody>
					<tr>
						<td><span class="td-style">CATEGORY Id:{{$data['category_id']}}</span>
					    </td>
					</tr>	
					<tr>
			...
			<table class = "table text-center" cellspacing="0">
				<tbody class="table-style">	
					<tr  class = "data-title" style="text-align: center">
					 ...
					 <tr>
						 <td style ="text-align: center;">{{ $data['estimated_price_breakup']['surge']}}</td>
						 <td style ="text-align: center;">{{ $data['estimated_price_breakup']['surge_multiplier']}}</td>
						 <td style ="text-align: center;">{{ $data['estimated_price_breakup']['multi_drop_price']}}</td>
						 <td style ="text-align: center;">{{$data['estimated_price_breakup']['multi_drop_price_per_drop']}}</td>
					</tr>	
				</tbody>
			</table>
		</div>
